                    ...
                    <div class="dataTables_paginate paging_bootstrap pagetion">
                        <ul>
                            ...
                            <#if page.currentPageNo==1>
				           	 ...
				           	 <#else>
				       			<li ><a class="arrowh2" href="###" title="上一页" onclick="bdpPage('${page.previousPageNo}','${pageTagformId}pageTagFormId','${isAjaxForm!''}')"></a></li>
				       		</#if>
                            ...
                            <#if hNext >
				       			<li ><a class="arrowh3" title="下一页"  href="###" onclick="bdpPage('${page.nextPageNo}','${pageTagformId}pageTagFormId','${isAjaxForm!''}')"> </a></li>
				           	<#else>
				           		<li><a class="arrowh31" title="下一页" href="###" > </a></li>
				       		</#if>
                            
                            <li >
                            <a href="###" class="arrowh4" title="尾页" onclick="bdpPage('${page.totalPageCount}','${pageTagformId}pageTagFormId','${isAjaxForm!''}')">
                            </a>
                            </li>
                        </ul>
                    </div>
