...
<body>
            ...
            <form class="form-inline" role="form">
                    <div class="table-responsive mt20">
                        ...
                        <table class="table table-bordered table-striped table-hover mt20">
                            <thead>
                                <tr>
                                    <th width="8%"><input type="checkbox" id="allUser" onclick="checkAll()">&nbsp;&nbsp;全选</th>
                                    <th width="46%">菜单名称</th>
                                    <th width="46%">菜单编码</th>
                                </tr>
                            </thead>
                            ...
                            <tbody id="hiddentable" >
		                      ...
		                      <#if menuList??>
								<#list menuList as res>
								   <#if res??>
		                                <tr>
		                                    <td><input type="checkbox" name="users" class="${(res.id)!''}" <#if res.comments?? && res.comments=='ok'>checked</#if>/></td>
		                                    <td>${(res.mhMenuName)!""}</td>
		                                    <td>${(res.mhMenuCode)!""}</td>
		                                </tr>
		                            </#if> 
		                        </#list>      
		                     </#if>   
    ...
    <script type="text/javascript">
        ...
        function subUserList(){
               ...
               window.location.href="${rc.contextPath}/menhu/opt-save/savePermissions.do?content="+str+"&roleId="+$("#roleId").val()+"&flag="+"menu";
