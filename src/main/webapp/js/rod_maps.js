/* [ ---- ROD Panel - location finder ---- ] */
    ...
    rod_maps = {
        init: function() {
            rod_maps.create();
            rod_maps.save_location();
            rod_maps.edit_location();
            rod_maps.show_location();
