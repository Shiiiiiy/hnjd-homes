...
public interface TeacherPortalService extends IBaseService{
	...
	/**查询  指定的学年 和 学院集合 查询 此时的  [教职工 总人数，行政类人数，教学类人数]   */
	public String[] queryTeacherTypeNumAll(String schyear, String academyN,
			List<String> academyList);
	/**查询 教师隶属的 机构ID表中, 包含学院的*/
	public String getTeaOrgN(List<String> org_ID, List<String> academyList);
	/**查询  指定的学年 和 学院 查询 此时的  [教职工男性人数，比重， 女性人数，比重]*/
	public String[] queryTeacherSexNum(String schyear, String academyN);
	/**查询 当前学年X  学院   年龄段人数[-30,30-35,35-40,40-45,45-50,50-55,55+ ] 规定集合 (1,4] 开 闭集 模式**/
	...
	/**对  queryMHstuFeeList结果进行汇总 没有到层*/
	public MHstatistStudentTuition queryMHstuFeeListAll(
			List<MHstatistStudentTuition> mHstuFeeList);
	/**查询 当前学年X  学院 总人数*/
	...
	public String[] queryListforline(String schyear, List<String> schyearList,
			String academyN);
	/**通过 登录的userId 获取门户 管理员 的 一个对象 */
	public MhTeacherUser getMhSuperUser(String userId);
	/***List +[生源地贷人数,校园地贷人数,缓人数,奖人数,助人数,免人数] */
	public List<MHstatistStudentTuition> queryMHstuFeeList2(String schyear,String academyN, List<MHstatistStudentTuition> mHstuFeeList,
			List<String> academyList);
